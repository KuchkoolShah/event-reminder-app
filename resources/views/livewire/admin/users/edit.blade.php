            ...
            <div class="bg-white rounded-lg shadow-md border border-gray-200 p-6">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Modify user details and roles</p>
                    </div>
        ...
        <div class="w-full md:w-2/3 lg:w-1/2">
            <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                <form wire:submit.prevent="update" class="p-6 space-y-5">
                    ...
                    {{-- New Password (optional) with toggle --}}
                    <div>
                        ...
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'" wire:model="password" id="password" placeholder="••••••••"
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('password') border-red-500 @enderror pr-10">
                            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-indigo-600">
                    ...
                    @else
                        ...
                        <div class="text-sm text-gray-500 bg-gray-50 p-3 rounded-md">
                            ⚠️ You don't have permission to assign roles. Existing roles will remain unchanged.
                        </div>
                    @endcan
